...
variable "acme_version" {
  description = "Version of keyvault-acmebot to deploy. Must be in the form vMAJOR.MINOR.PATCH (e.g. v5.1.4). Renovate automatically creates PRs for new releases from https://github.com/shibayan/keyvault-acmebot/releases"
  type        = string
  default     = "v5.1.4"
  validation {
